...
class ReactDemo extends React.Component {
  ...
  onFileChange(e) {
    ...
    if (files) {
      ...
      imageCompressor.compress(files[0], resCompress).then((result) => {
          ...
          {!showCropper && (
            <div className={changeStyle(isMobile, "content")}>
              <div className={changeStyle(isMobile, "image")}>
                <img
                  className={changeStyle(isMobile, "img")}
                  src={imgSrc}
                  alt=""
                />
              </div>
              ...
              <div className={changeStyle(isMobile, "btnGroup")}>
                <div className={changeStyle(isMobile, "fileBtn")}>
                  {isQ() ? (
                    <input
                      id="cropperInput"
                      className={changeStyle(isMobile, "file")}
                      capture="camera"
                      type="file"
                  ...
                  <div className={changeStyle(isMobile, "btn")}>{btnText}</div>
                </div>
              </div>
          ...
          {showCropper && (
            <div className={changeStyle(isMobile, "content")}>
              <Crop
                ...
                onChangeShowCropper={(showCropper) =>
                  this.changeShowCropper(showCropper)
                }
                onChangeShowCropper={(showCropper) =>
                  this.changeShowCropper(showCropper)
                }
